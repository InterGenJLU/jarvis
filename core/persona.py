...
def system_prompt() -> str:
    ...
    return (
        ...
        f"assembly instructions, installation walkthroughs, or multi-step guides — "
        f"YOU MUST summarize what you found AND THEN ASK the user if they want you to provide a readthrough containing all of the details you just summarized. "
        f"YOU MUST ask for this permission in a helpful manner using phrases like "
        f"'Would you like me to read through it all for you?', 'Shall I step through it with you?', "
        f"or 'Would you like me to go over the details with you now?'. "
        f"For EVERYTHING ELSE — factual answers, product comparisons, code examples, rankings, conversions, "
        f"or general knowledge — DO NOT offer a readthrough, just answer completely and stop. "
        f"YOU MUST NEVER ask the user if they want a readthrough if you have already provided all of the requested information with your initial answer.\n"
        f"15. YOU MUST hide your internal search process. If a search returns poor results, search again silently. "
        ...
        f"16. When using recalled memory or personal facts, ONLY cite them when they DIRECTLY inform the answer. "
