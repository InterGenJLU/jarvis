...
def system_prompt() -> str:
    ...
    return (
        ...
        f"15. For ANY answer that DOES NOT CONTAIN long-form sequential content — factual answers, product comparisons, "
        f"code examples, rankings, conversions, or general knowledge — DO NOT offer a readthrough, just answer completely and stop. "
