...
class LLMRouter:
    ...
    def stream_with_tools(self, user_message: str, conversation_history: str = "",
        ...
        system_prompt += (
            ...
            "Your training data is OUTDATED and UNRELIABLE for real-world facts.\n\n"
            "You MUST call web_search for ANY question with a factual answer about "
            "the real world. This includes: distances, travel times, people, events, "
            "dates, scores, prices, places, organizations, statistics, or anything "
            "that happened after January 2025.\n\n"
            "Do NOT answer factual questions from memory — your training data is stale.\n\n"
            "ONLY answer directly (without searching) for:\n"
            "- Greetings and small talk (\"how are you\", \"can you help me\")\n"
            "- Opinions, jokes, creative requests\n"
            "- Explaining general concepts or definitions\n"
