    ...
    def continue_after_tool_call(self, tool_call: ToolCallRequest,
        ...
        if tools:
            ...
            synthesis_text = (
                ...
                "or multi-step guides — YOU MUST summarize what you found AND THEN ASK the user if they "
                "want a readthrough.\n"
                "3. For ANY answer that DOES NOT CONTAIN long-form sequential content — factual answers, "
                "product comparisons, code examples, rankings, conversions, or general knowledge — "
                "DO NOT offer a readthrough, just answer completely and stop. "
                "YOU MUST NEVER offer a readthrough if you have already provided all of the requested information.\n"
                f"4. {honorific_rule}\n"
            ...
            synthesis_text = (
                ...
                "or multi-step guides — YOU MUST summarize what you found AND THEN ASK the user if they "
                "want a readthrough.\n"
                "2. For ANY answer that DOES NOT CONTAIN long-form sequential content — factual answers, "
                "product comparisons, code examples, rankings, conversions, or general knowledge — "
                "DO NOT offer a readthrough, just answer completely and stop. "
                "YOU MUST NEVER offer a readthrough if you have already provided all of the requested information.\n"
