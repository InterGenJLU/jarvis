    ...
    def continue_after_tool_call(self, tool_call: ToolCallRequest,
        ...
        if tools:
            ...
            synthesis_text = (
                ...
                "2. For ANY answer with long-form sequential content — lists with more than 5 items, "
                "recipes with ingredients and steps, assembly instructions, installation walkthroughs, "
                "or multi-step guides (but NOT code snippets or command examples) — "
                "YOU MUST give a SHORT summary (1-3 sentences stating what you found "
                "and how many items or steps, WITHOUT listing the actual items or details) AND THEN ASK "
                "if they want a readthrough.\n"
                "3. BEFORE offering a readthrough, check: does your response already contain the detailed items, "
                "steps, or point-by-point breakdown? If YES — DO NOT offer a readthrough. Just stop. "
                "A readthrough only delivers detail you held back. If you wrote it all out, there is nothing "
                "left to read through. This also applies to code examples, factual answers, product comparisons, "
                "rankings, conversions, travel recommendations, sightseeing suggestions, and general knowledge.\n"
                f"4. {honorific_rule}\n"
            ...
            synthesis_text = (
                f"Today's date is {today}. Current time: {current_time}.\n"
                "RULES — follow these EXACTLY:\n"
                "1. For ANY answer with long-form sequential content — lists with more than 5 items, "
                "recipes with ingredients and steps, assembly instructions, installation walkthroughs, "
                "or multi-step guides (but NOT code snippets or command examples) — "
                "YOU MUST give a SHORT summary (1-3 sentences stating what you found "
                "and how many items or steps, WITHOUT listing the actual items or details) AND THEN ASK "
                "if they want a readthrough.\n"
                "2. BEFORE offering a readthrough, check: does your response already contain the detailed items, "
                "steps, or point-by-point breakdown? If YES — DO NOT offer a readthrough. Just stop. "
                "A readthrough only delivers detail you held back. If you wrote it all out, there is nothing "
                "left to read through. This also applies to code examples, factual answers, product comparisons, "
                "rankings, conversions, travel recommendations, sightseeing suggestions, and general knowledge.\n"
                "3. YOU MUST give a direct answer. "
                ...
                "4. YOU MUST maintain strict political neutrality — present facts objectively. "
                "DO NOT add editorial bias, emphasis on controversies, or opinionated framing.\n"
                "5. YOU MUST compare any event dates in the results against today's date. "
                ...
                "6. If the results DO NOT contain a clear answer, YOU MUST say so honestly. "
                "DO NOT fabricate or guess.\n"
                f"7. {honorific_rule}\n"
                "8. DO NOT start with filler like 'Certainly', 'Of course', 'Absolutely'. "
                "YOU MUST jump straight into the answer. "
