    ...
    def continue_after_tool_call(self, tool_call: ToolCallRequest,
        ...
        if tools:
            ...
            synthesis_text = (
                ...
                "want a readthrough. For EVERYTHING ELSE — factual answers, product comparisons, "
                "code examples, rankings, conversions, or general knowledge — DO NOT offer a readthrough, "
                "just answer completely and stop. YOU MUST NEVER offer a readthrough if you have already "
